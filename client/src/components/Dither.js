...
function DitheredWaves({
  ...
  const backgroundColor = theme === 'light' ? [0.922, 0.922, 0.922] : [0.0, 0.0, 0.0];
  ...
  useFrame(({ clock }) => {
    ...
    const currentBgColor = theme === 'light' ? [0.922, 0.922, 0.922] : [0.0, 0.0, 0.0];
    ...
    if (prevTheme.current !== theme) {
      u.backgroundColor.value.set(...currentBgColor);
